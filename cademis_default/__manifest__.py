...

{
    ...
    'version': '13.0.0.0.0',
    'category': 'Tools',
    'summary': "Cademis v13 CE",
    'website': 'https://github.com/regaby/cl-cademis',
    'license': 'AGPL-3',
    'depends': [
        # basic applications
        'sale_management',
    ...
    'git-repos': [
        'https://github.com/regaby/cl-cademis.git',
        ...
        'https://github.com/ctmil/account_debt_management.git',
    ],
